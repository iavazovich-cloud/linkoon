  ...
  const blogPosts = [
    {
      ...
      metaDescription: {
        en: "Learn the fundamentals of SEO and why it matters for Uzbek businesses. Complete guide to search engine optimization.",
    ...
    },
    {
      ...
      metaDescription: {
        en: "Discover the 7 most common technical issues preventing your website from ranking on Google and how to fix them.",
        uz: "Saytingiz Google'da chiqmasligiga sabab bo'layotgan 7 ta texnik muammoni va ularni qanday tuzatishni bilib oling.",
        ru: "Узнайте 7 технических проблем, мешающих вашему сайту ранжироваться в Google."
      },
      excerpt: {
        en: "Discover the technical issues preventing your website from ranking on Google.",
    ...
    },
    {
      ...
      metaDescription: {
        en: "The complete SEO roadmap for businesses targeting the Uzbek market in 2026. Keyword research, content strategy, technical SEO.",
